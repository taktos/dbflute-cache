...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
     ...
     * PURCHASE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param purchaseId The value of purchaseId as notEqual.
     */
     ...
     * PURCHASE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of purchaseId. (NullAllowed)
     * @param maxNumber The max number of purchaseId. (NullAllowed)
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * PURCHASE_DATETIME: {UQ+, IX, NotNull, TIMESTAMP(23, 10)}
     * @param fromDatetime The from-datetime(yyyy/MM/dd HH:mm:ss.SSS) of purchaseDatetime. (NullAllowed)
     * @param toDatetime The to-datetime(yyyy/MM/dd HH:mm:ss.SSS) of purchaseDatetime. (NullAllowed)
     ...
     * </pre>
     * @param fromDate The from-date(yyyy/MM/dd) of purchaseDatetime. (NullAllowed)
     * @param toDate The to-date(yyyy/MM/dd) of purchaseDatetime. (NullAllowed)
     */
    public void setPurchaseDatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setPurchaseDatetime_FromTo(fromDate, toDate, new DateFromToOption());
    }
     ...
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * PURCHASE_COUNT: {NotNull, INTEGER(10)}
     * @param purchaseCount The value of purchaseCount as notEqual.
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * PURCHASE_COUNT: {NotNull, INTEGER(10)}
     * @param minNumber The min number of purchaseCount. (NullAllowed)
     * @param maxNumber The max number of purchaseCount. (NullAllowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
     ...
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * PURCHASE_PRICE: {IX, NotNull, INTEGER(10)}
     * @param purchasePrice The value of purchasePrice as notEqual.
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * PURCHASE_PRICE: {IX, NotNull, INTEGER(10)}
     * @param minNumber The min number of purchasePrice. (NullAllowed)
     * @param maxNumber The max number of purchasePrice. (NullAllowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
     ...
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlg The value of paymentCompleteFlg as notEqual.
     */
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlg The value of paymentCompleteFlg as greaterThan.
     */
     ...
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlg The value of paymentCompleteFlg as lessThan.
     */
     ...
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlg The value of paymentCompleteFlg as greaterEqual.
     */
     ...
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlg The value of paymentCompleteFlg as lessEqual.
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param minNumber The min number of paymentCompleteFlg. (NullAllowed)
     * @param maxNumber The max number of paymentCompleteFlg. (NullAllowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setPaymentCompleteFlg_RangeOf(Integer minNumber, Integer maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, getCValuePaymentCompleteFlg(), "PAYMENT_COMPLETE_FLG", rangeOfOption);
    }
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * PAYMENT_COMPLETE_FLG: {NotNull, INTEGER(10)}
     * @param paymentCompleteFlgList The collection of paymentCompleteFlg as notInScope.
     */
    ...
    protected void xscalarCondition(String function, SubQuery<PurchaseCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForScalarCondition(this); subQuery.query(cb);
