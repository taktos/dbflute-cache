...
public abstract class AbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {
    ...
    protected void xscalarCondition(String function, SubQuery<MemberWithdrawalCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<MemberWithdrawalCB>", subQuery);
        MemberWithdrawalCB cb = new MemberWithdrawalCB(); cb.xsetupForScalarCondition(this); subQuery.query(cb);
